#wrire wt9.txt form distinct words ordered by their frequencies using wt6.txt and ucsc.txt
...
conn.commit()
c.execute("SELECT word FROM words ORDER BY freq DESC")
results = c.fetchall()

f = codecs.open("wt8.txt", 'w', encoding='utf-8')
